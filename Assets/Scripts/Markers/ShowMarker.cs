...
namespace Microsoft.MixedReality.WorldLocking.Samples.Advanced.QRSpacePins
{
    ...
    public class ShowMarker : MonoBehaviour
    {
        ...
        /// </summary>
        private readonly List<AnimMat> materials = new List<AnimMat>();
        ...
        private void Start()
        {
            ...
            for (int i = 0; i < renderers.Length; ++i)
            {
                ...
                if (!rend.material.HasProperty(diffuseName)) continue;
                if (!rend.material.HasProperty(emissiveName)) continue;
