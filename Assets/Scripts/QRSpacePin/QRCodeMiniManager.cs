...
namespace Microsoft.MixedReality.WorldLocking.Samples.Advanced.QRSpacePins
{
    ...
    public class QRCodeMiniManager : MonoBehaviour
    {
        ...
        /// </summary>
        private QRCodeWatcherAccessStatus _accessStatus = QRCodeWatcherAccessStatus.UserPromptRequired;
        ...
        private System.Threading.Tasks.Task<QRCodeWatcherAccessStatus> _capabilityTask;
        ...
        private void CheckQRCodeWatcher()
        {
            ...
            if (_qrWatcher == null && IsSupported && _capabilityInitialized && _accessStatus == QRCodeWatcherAccessStatus.Allowed)
            {
                SetUpQRWatcher();
            }
        }
        ...
        private void SetUpQRWatcher()
        {
            ...
            SimpleConsole.AddLine(log, $"SetUpQRWatcher {(_qrWatcher != null ? "Success" : "Failed")}");
        }
